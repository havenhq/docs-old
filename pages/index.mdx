...
```bash copy
gcloud compute instances create-with-container <manager-instance-name> --container-image gcr.io/PROJECT_ID/IMAGE_NAME --machine-type MACHINE_TYPE --container-env BEARER_TOKEN=<your-bearer-token>
```
