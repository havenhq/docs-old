...
```bash copy
gcloud compute instances create-with-container <manager-instance-name> --container-image havenhq/haven --machine-type n1-standard-1 --container-env BEARER_TOKEN=<your-bearer-token> --tags==http-server,https-server,permissive-firewall-rule
```
