...
**Prerequisites**:\
You have a Google Cloud account and have the gcloud CLI installed. Installation instructions for the gcloud CLI can be found [here](https://cloud.google.com/sdk/docs/install?hl=en)
