...
```bash copy
gcloud compute instances create-with-container haven-manager --container-image havenhq/haven --machine-type n1-standard-1 --container-env BEARER_TOKEN=<some-bearer-token> --tags=http-server,https-server
```
