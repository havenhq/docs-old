...
A model class can be mapped to multiple configurations, which are defined by the GPU types, the number of GPUs as well as the quantization format different models can be deployed with. Below, you can find 
